...
export default function RotinasOperacionaisPage() {
    return (
        <main className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
            <div>
                <h1 className="text-3xl font-bold tracking-tight">Rotinas</h1>
                <p className="text-muted-foreground mt-1 text-sm">
                    Acompanhe e execute suas rotinas operacionais diárias.
                </p>
            </div>
            ...
            <Card className="border-dashed border-2 shadow-sm bg-background/50">
                <CardHeader className="text-center pb-2">
                    ...
                    <CardTitle>Nenhuma rotina para hoje</CardTitle>
                    <CardDescription>
                        Você não possui rotinas pendentes no momento. Aproveite seu turno!
                    </CardDescription>
                </CardHeader>
